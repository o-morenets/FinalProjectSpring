...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (1, true, true, true, 'a@ua', true, 'a', 'a', '$2a$10$ajxcWhSO9U.9gLYLe4LtleEQTsGglVKWWEf4VXTTQBoN4q2gF6Ir.', 'a', null);
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (2, true, true, true, 'z@ua', true, 'z', 'z', '$2a$10$sUbptpNWjkgAA4aPx1BvP.ASfSgcw7YogHUUH/40VSGk/Er6UGxE.', 'z', 2);
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (3, true, true, true, 'x@ua', true, 'x', 'x', '$2a$10$eb0DPeaKRHBok/mzpqlws.tLRNp7L6abDLVY/uzczHs1JqyoH8Aa6', 'x', 3);
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (4, true, true, true, 'q@ua', true, 'q', 'q', '$2a$10$Fy1DgLO32O/lns/TTwWTTeNd5Xk.moqjrLnvFIwMoOkYTkhnXmLP2', 'q', 1);
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (5, true, true, true, 's@ua', true, 's', 's', '$2a$10$S/urAoe6GhQvep9NtHksGOkTE91zByRQQSKkrTfcU4NP.2pbzjBCe', 's', null);
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (6, true, true, true, 'w@ua', true, 'w', 'w', '$2a$10$M59G5hkXHBKbUBqTs0pzDO8VPV9k3pndgf0jwuLnbuVDI/725EXay', 'w', 4);
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (7, true, true, true, 'admin@ua', true, 'Admin', 'ADMIN', '$2a$10$llwghixwtyuVUEJk2Hy/xe7Hdm2EkJ8zBbccvnCQCHgRqWFMWtJP.', 'admin', null);
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (8, true, true, true, 'user@ua', true, 'User', 'USER', '$2a$10$fcKxpgxwtsYOQ97H1G0OhOWIecQ6pCqHZUk4zEpq4/lAllYvrHQhW', 'user', null);
INSERT INTO `usr` (`id`, `account_non_expired`, `account_non_locked`, `credentials_non_expired`, `email`, `enabled`, `first_name`, `last_name`, `password`, `username`, `speciality_id`) VALUES (9, true, true, true, 'student@ua', true, 'Student', 'STUDENT', '$2a$10$cZjX/8jHXUbPNqjpT6N7DOcXln3N0tLa.14jp.SU.FUzxgt6NEtDS', 'student', null);
